<?php 
	...
	if (isset($_POST['reg_user'])) {
		...
		$userrole = mysqli_real_escape_string($db, $_POST['userrrole']);
		...
		if (count($errors) == 0) {
			...
			$query = "INSERT INTO manager (username, userrole, email, password) 
					  VALUES('$username', '$userrole', '$email', '$password')";
