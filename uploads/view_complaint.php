...
<link rel="nofollow" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js">
  <div class="container">
		...
		<table class="table table-striped table-bordered table-hover gridtable" style="table-layout:fixed;" id="Select-b">
			...
			<?php
				...
				while($row=mysqli_fetch_array($query)){
					?>
					<tr>
						<td id='ctable'><?php echo $row['name']; ?></td>
						<td id='ctable'><?php echo $row['number']; ?></td>
						<td id='ctable'><?php echo $row['cname']; ?></td>
                        <td id='ctable'><?php echo $row['subject']; ?></td>
                        <td id='ctable'><?php echo $row['description']; ?></td>
						<td> 
							<a href="#del<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
							<?php include('c_button.php'); ?>
						</td>
					</tr>
					<?php
				}
