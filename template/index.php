...
<html lang="en">
  ...
  <select class="form-control" style="width: 200px;" onchange="javascript:location.href = this.value;">
    ...
    <option name="tm1" value="./tmp1.php" class="form-control">Temple 1</option>
    <option name="tm2" value="./tmp2.php" class="form-control">Temple 2</option>
    <option name="tm3" value="./tmp3.php" class="form-control">Temple 3</option>
    <option name="tm4" value="./tmp4.php" class="form-control">Temple 4</option>
  </select>
  </center>
        </div>
      </div>
