...
<div class="container-scroller">
	...
	<!-- header -->
	<div class="header">
								<li><a href="view_cart_user.php"  id="cart-info" title="View Cart">  <span class="glyphicon glyphicon-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"></span></span><?php 
