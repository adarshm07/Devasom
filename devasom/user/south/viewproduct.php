			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="container">
					...
					<span class="icon-bar"></span>
						...
						<a class="navbar-brand" href="http://localhost/devasom/devasom/devasom/employee/manager/collector.php">
							<h1>NALAMBALAM</h1>
						</a>
					</div>
					<!--/.navbar-header-->
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								<li><a href="http://localhost/devasom/devasom/devasom/user/index.php" class="active">Home</a></li>
