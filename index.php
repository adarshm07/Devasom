...
<a href="./login.php" class="btn navbar-btn btn-ghost"><i class="fa fa-sign-in"></i>Login</a>
    ...
    <div class="jumbotron main-jumbotron">
      <div class="container">
        <div class="content">
          <h1>This is Multi</h1>
          <p class="margin-bottom">Bootstrap Multipurpose Template by <a href="https://bootstraptemple.com">Bootstrap Temple</a></p>
      ...
      <div class="footer__copyright">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6">
              <p class="credit">Template by <a href="https://bootstraptemple.com" class="external">Bootstrap Temple</a></p>
